...
conn = mysql.connector.connect(host='localhost', user='root', password='Aby@0210', database='db_1')
...
INSERT INTO Student(StudentID,Name,Email,Phone,Address)
 VALUES (1,"John Doe", "john.doe@example.com", "123-456-7890", "123 Main St"),
        ...
        (8, "Melissa Turner", "melissa.turner@example.com", "888-999-0000", "456 Redwood Rd");
'''
Insert_2 = '''
